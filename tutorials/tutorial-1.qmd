...
For this workshop, we'll be using the [NOAA NMFS JupyterHub](https://nmfs-openscapes.2i2c.cloud). You're welcome to use your own version of RStudio on your desktop, just make sure R and RStudio are updated to the latest versions.
